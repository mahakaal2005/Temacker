...
Status: implemented and verified on-device 2026-09-19 (unit tests deferred; see `specs/office/progress.md`).
...
- [x] On-device golden path — run 2026-09-19, see `specs/office/progress.md`.
