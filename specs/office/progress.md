...
- [x] **On-device golden path verified (2026-09-15):** sign in (Google) → No-project gate → create project → Home ("1 members · You lead") → Roster (Leader row, member count, Manage roles link, invite button) all confirmed working on the connected physical device. Manage roles, invite-code join flow, remove member, reassign role, and sign-out/re-entry not yet exercised — do these next.
